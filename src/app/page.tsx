  ...
  return (
    <main className="w-full">
      <HeroContainer>
        ...
        <h1 className="text-center font-bold text-xl">Separamos um jogo para voce</h1>
          ...
          <section className="w-full bg-black rounded-lg">
            ...
            <div className="w-full max-h-96 h-96 relative rounded-lg">
              ...
              <div className="absolute z-20 bottom-0 p-3 flex justify-center items-center gap-2 ">
                ...
                <i className="text-xl text-white"><BsArrowRightSquare/></i>
              </div>

              <Image src={dalyGame.image_url} alt={dalyGame.title} priority={true} quality={100} fill={true}
